public class Main {
    public static void main(String[] args) {
       ...
       /* Задача 1
        ...
        int age = 17;
        String msg = "Если возраст человека равен %d %s \n";
        if (age >= 18) {
            System.out.printf(msg, age, ", то он совершеннолетний");
        } else {
            System.out.printf(msg, age, ", то он не достиг совершеннолетия, нужно немного подождать.");
        }
        /* Задача 2
